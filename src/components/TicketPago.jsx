...
function TicketPago({ datosTicket, onClose }) {
    ...
    <div className="modal-overlay" onClick={() => onClose()}>
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '400px' }}>
        <div className="modal-header">
          <h2 className="modal-title">Ticket de Pago</h2>
        ...
        <div className="ticket-container" style={{ 
          ...
          <div style={{ marginBottom: '15px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
              <span>Fecha:</span>
              <span>{formatearFecha(datosTicket.fecha_pago)}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
              <span>Hora:</span>
          ...
          <div style={{ marginBottom: '15px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
              <span>Cliente:</span>
              <span style={{ fontWeight: 'bold' }}>{datosTicket.cliente_nombre || 'N/A'}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
              <span>Teléfono:</span>
              <span>{datosTicket.cliente_telefono || 'N/A'}</span>
            </div>
          </div>
          ...
          <div style={{ marginBottom: '15px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
              <span>Concepto:</span>
              <span style={{ fontWeight: 'bold' }}>{datosTicket.concepto || 'Pago de Membresía'}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
            ...
            {datosTicket.observaciones && (
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
                <span>Observaciones:</span>
                <span>{datosTicket.observaciones}</span>
              </div>
            )}
          </div>
          ...
          <div style={{ 
            ...
            <div>¡Gracias por elegir GYM CENTER!</div>
